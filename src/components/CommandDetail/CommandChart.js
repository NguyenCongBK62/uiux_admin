    ...
    return (
        <>
            <div className='command-chart-title'>
                <div className='command-chart-title-content'>Chuyền 1: Áo thể dục Bách Khoa</div>
                <Link to='/productlinedetail' style={{textDecoration: 'none', color: 'white'}}><LoginOutlined className='command-chart-title-icon'/></Link>
            </div>
